...
const Testimonial = (_) => {
  ...
  const items = [
    {
      ...
      feedback:
        "O meu despertar da consciência foi um processo guiado pela Cintya Flores. Desenhar mandalas e compreender sua simbologia foi determinante neste processo",
      name: "Tânia Dantas",
    ...
    },
    {
      ...
      feedback:
        "Descubra seus mistérios e melhores sentimentos dentro das mágicas mandalas. Elas me levavam a esta linda viagem!",
  ...
  return (
    <div id="customers" className={`section ${styles.testimonial}`}>
      <h2 className={`title ${styles.title}`}>{t("clientFeed")}</h2>
