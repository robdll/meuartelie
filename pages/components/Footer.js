...
const Footer = (_) => {
  ...
  return (
    <div className={`section ${styles.footer}`}>
      <span className={styles.footer__logo}>{t("topHomeHeader1")}</span>
      <p className={styles.footer__copy}>{t("footerTitle")}</p>
      <span className={styles.footer__list_title}>{t("footerSubTitle")}</span>
      <div className={styles.sitemap__container}>
        <ul className={styles.footer__list}>
          ...
          <li>
            <Link href="/#about">
              <span>{t("footerChild1")}</span>
            </Link>
          </li>
          <li>
            <Link href="/#project">
              <span>{t("footerChild2")}</span>
            </Link>
          </li>
          <li>
            <Link href="/#services">
      ...
      <span className={styles.footer__list_title}>{t("footerChild6")}</span>
      <article className={styles.footer__socials_container}>
        ...
        <Link href="https://www.facebook.com/meuartelie">
          <span className={`${styles.facebook} ${styles.footer__icon}`}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 6.445 12.033">
              <path
                d="M7.632,6.768l.334-2.178H5.876V3.178A1.089,1.089,0,0,1,7.1,2h.95V.147A11.584,11.584,0,0,0,6.368,0,2.659,2.659,0,0,0,3.522,2.931v1.66H1.609V6.768H3.522v5.264H5.876V6.768Z"
      ...
      <ul className={`${styles.footer__list} ${styles.footer__contact}`}>
        <li className={`${styles.flex} ${styles.email}`}>
          <EmailIcon></EmailIcon>
          <Link href="/services#contact"> cintya@meuartelie.com </Link>
        </li>
